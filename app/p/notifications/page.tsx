...
import Notifications_Next15 from "@/modules/notifications_next15";

const inter = Inter({ subsets: ['latin', "latin-ext"], variable:"--font-inter" }) ; // weight:["100", "200", '300', "400", '500', "600","700", "800", "900"],

export default async function NotificationsPage(context) {
  ...
  return (
      <div className={s.shell}> 
        ...
        {userdata?.email}
                  ...
                  <Notifications_Next15 userdata={userdata} selecteduser={undefined}/>
        </div>
  );
}
