...
import Messages_Next15 from "@/modules/messages_next15";
import Forms_Next15 from "@/modules/forms_next15";

const inter = Inter({ subsets: ['latin', "latin-ext"], variable:"--font-inter" }) ; // weight:["100", "200", '300', "400", '500', "600","700", "800", "900"],

export default async function MessagesPage(context) {
  ...
  return (
      <div className={s.shell}> 
        ...
        {userdata?.email}
                ...
                <Forms_Next15 userdata={userdata} selecteduser={undefined} childTabStateObj_1={undefined} tabCount={4} domain="netcoor.com" project_type="independent" module_type={"free"} defaultusername={defaultusername} defaultdetail={undefined} defaultamount={undefined} defaultphone={defaultuserphone}/>
        </div>
  );
}
