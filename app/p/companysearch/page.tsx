...
import CompanySearch from "@/modules/myaccount/companysearch";


const inter = Inter({ subsets: ['latin', "latin-ext"], variable:"--font-inter" }) ; // weight:["100", "200", '300', "400", '500', "600","700", "800", "900"],

export default async function CompanySearchPage(context) {
  ...
  return ( 
            <div className={s.shell}>             
                                       <CompanySearch userdata={userdata}   selecteduser={userdata?.email}/>
            </div>
          );
}
